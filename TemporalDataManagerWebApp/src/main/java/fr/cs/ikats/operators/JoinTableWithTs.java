...
/**
 * The class JoinTableWithTs is mixing the use of several business managers
 * (TableManager, MetadataManager, DatasetManager ...) in order to propose the Table operator
 * <p/>
 * The new level of package fr.cs.ikats.operators, enables to isolate each resource
 * managers (here TableManager) from the others (here: MetadataManager,
 * DatasetManager, etc).
 * <p/>
...
public class JoinTableWithTs {
    ...
    final static private String MSG_TABLE_PROCESSING_CONTEXT= "[JoinTableWithTs step ''{0}'' on table='''{1}']";
    
    private static final String MSG_DAO_KO_JOIN_BY_METRICS = "Failed to apply operator in context=''{2}'': DAO error occured with dataset name=''{0}'' on metrics=''{1}''";
    private static final String MSG_INVALID_METRICS_FOR_JOIN_BY_METRICS = "Invalid metrics value=''{0}'' with dataset name=''{1}'' context=''{2}''";
    private static final String MSG_INVALID_TABLE_FOR_JOIN_BY_METRICS = "Invalid table in context=''{0}'' with dataset name=''{1}'' and metrics=''{2}''";
    private static final String MSG_RESOURCE_NOT_FOUND_JOIN_BY_METRICS = "Resource not found error occurred in context=''{2}'' with dataset name=''{0}'' metrics=''{1}''";
    private static final String MSG_UNEXPECTED_ERROR_JOIN_BY_METRICS = "Unexpected error occured in context=''{2}'' with dataset name=''{0}'' on metrics=''{1}''";
    private static final String MSG_INVALID_INPUT_ERROR_JOIN_BY_METRICS = "Invalid input name=''{0}'' value=''{1}'' in context=''{4}'' with dataset name=''{2}'' on metrics=''{3}''";
    ...
    /**
     * See API doc reference in {@link TableResource#joinByMetrics(String, String, String, String, String, String, String)}
     * @param tableJson
     * @param metrics
     * @param dataset
     * @param joinColName
     ...
     */
    public String apply(String tableJson, 
            String metrics, 
            String dataset, 
            String joinColName, 
            String joinMetaName, 
            ...
            throws IkatsDaoException, InvalidValueException, ResourceNotFoundException, IkatsException 
    {
        ...
        try {
            ...
            processedTable = computeTable( tableJson,  metrics, dataset, joinColName, joinMetaName, targetColName, outputTableName);
            chrono.stop(LOGGER);
            ...
            throws IkatsDaoException, InvalidValueException, ResourceNotFoundException, IkatsException 
    {
        try {
            ...
            if (preparedMetrics.length() == 0)
                throw new InvalidValueException(MessageFormat.format(MSG_INVALID_METRICS_FOR_JOIN_BY_METRICS, metrics, dataset, getContext()));
