...
public class TableUtils {
     ...
     */
    private static List<List<Integer>> randomSplitTableIndexes(List<Integer> indexList, double repartitionRate) {
     ...
     */
    public static List<Table> randomSplitTable(Table table, double repartitionRate) throws ResourceNotFoundException, IkatsException {
     ...
     */
    public static List<Table> trainTestSplitTable(Table table, String targetColumnName, double repartitionRate) throws
     ...
     * @throws ResourceNotFoundException row from original table is not found
     */
    private static Table extractIndexes(Table tableIn, Table tableOut, List<Integer> indexList) throws ResourceNotFoundException, IkatsException {
