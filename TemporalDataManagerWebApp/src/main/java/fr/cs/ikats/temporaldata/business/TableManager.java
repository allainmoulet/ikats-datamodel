...
public class TableManager {
    ...
    static public class Table {
        ...
        // ?
        // Review#158227 Resp. MBD begin
        // On missing value: I prefer to return -1 as index ... like
        // String.indexOf(...) for instance
        // On null header or data: it is an unexpected error, perhaps because
        // the Table is badly initialized: I prefer to
        // throw a simple IkatsException
        // Review#158227 Resp. MBD end
        /**
        ...
        private int getHeaderIndex(Header theHeader, String value) throws IkatsException {
            ...
            // Review#158227 Because this method is called several times, a good
            // idea is to use a hash map instead of parsing every time the table
            // Review#158227 Resp. MBD begin
            // I agree, but perhaps it is not quite justified to optimize this
            // part right now.
            // Review#158227 Resp. MBD end
         ...
         * @throws IkatsException
         *             unexpected error occurred: for example ClassCastException
         *             error.
         */
         ...
         * @throws IkatsException
         *             row header is undefined or unexpected internal error like
         ...
         *
         * @param rowName
         *            name of the selected row: this criterion is in the row
         *            header.
         ...
         *            false will insert null value for the left column header.
         * @param defaultLink
         *            the DataLink providing default values for column links
         * @param manageLinks
         *            true activate the link management
    ...
    /**
     * Creates and initializes the structure of an empty Table, with columns
    ...
    public Table initEmptyTable() {
        ...
        // Review#158227 Is the following line useful ? I think this could be
        // init by constructor
        // Review#158227 Resp. MBD begin
        // the dummy constructor is also used by Jackson parser: I want it the
        // simpler possible. In order to avoid useless ArrayList allocations.
        // Review#158227 Resp. MBD end
     ...
     *
     * @param columnHeaders
     *            list of column headers provided as String
    ...
    public TableInfo readFromDatabase(String tableName) throws IkatsJsonException, IkatsDaoException, ResourceNotFoundException {
        ...
        try {
            ...
            if (dataTables == null) {
                // Review#158227 I didn't found when this case occurs. Probably
                // dead code
                // Review#158227 Resp. MBD begin
                //    this may occurre : null returned in case of Hibernate exception 
                // Review#158227 Resp. MBD end
    ...
    public String createInDatabase(String tableName, TableInfo tableToStore)
        ...
        // Review#158227: I don't think tableToStore is updated but the return
        // value (not found here) contain the new instance
        // Review#158227 Resp. MBD begin
        //   reviewed: ok for me.
        // Review#158227 Resp. MBD end
        ...
        // Review#158227: This should be done before to prevent from
     ...
     * @throws IkatsException
     *             unexpected error occurred. example: internal
