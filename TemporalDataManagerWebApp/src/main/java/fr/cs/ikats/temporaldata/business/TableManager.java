...
public class TableManager {
     ...
     *
     * @throws IkatsException            unexpected error occurred. Example: internal ClassCastException when List<T>
     *                                   does not fit the actual data.
     * @throws IkatsDaoException         unexpected hibernate exception reading the table from database.
     * @throws ResourceNotFoundException either the resource Table named tableName is not found in the database, or the
     ...
     * @param castingClass the class specifying the type of T. Technically required, to call the cast operation.
     *                     Examples: Object.class will configure permissive cast, contrary to Integer.class, which
     *                     requires that every item is an Integer or null. See method description above for possible
     *                     option String.class.
     *
