...
public class TablesMergeTest {
    ...
    private static final String TABLE2_CSV       = "H2-1;H2-2;H2-3;H1-1;H1-2\n"
            + "0;9,42;0;H;eight\n"
            + "15,71;6,28;3,14;E;five\n"
            + "6,28;12,57;12,57;D;four\n"
            + "15,71;0;0;I;nine\n"
            + "12,57;12,57;6,28;A;one\n"
            + "15,71;0;9,42;G;seven\n"
            + "12,57;12,57;6,28;F;six\n"
            + "12,57;9,42;12,57;J;ten\n"
            + "6,28;6,28;12,57;C;three\n"
            + "0;15,71;3,14;B;two";
    ...
    public final void testDoMergeNominal() throws IOException, IkatsException, IkatsOperatorException {
        ...
        String EXPECTED_MERGE_1 = "H1-1;H1-2;H1-3;H1-4;H1-5;H2-1;H2-2;H2-3;H1-1\n"
                + "H;eight;08;8;1000;9,42;6,28;6,28;H\n"
                + "E;five;05;5;0101;3,14;12,57;9,42;E\n"
                + "D;four;04;4;0100;3,14;0;6,28;D\n"
                + "I;nine;09;9;1001;6,28;0;3,14;I\n"
                + "A;one;01;1;0001;15,71;6,28;0;A\n"
                + "G;seven;07;7;0111;3,14;9,42;0;G\n"
                + "F;six;06;6;0110;15,71;6,28;15,71;F\n"
                + "J;ten;10;10;1010;0;9,42;12,57;J\n"
                + "C;three;03;3;0011;6,28;0;12,57;C\n"
                + "B;two;02;2;0010;3,14;15,71;6,28;B";
    ...
    @Test
    public final void testDoMergeWithoutColumHeaders() {
        fail("Not yet implemented"); // TODO
    }
